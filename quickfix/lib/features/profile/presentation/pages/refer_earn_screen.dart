...
class _ReferEarnScreenState extends ConsumerState<ReferEarnScreen> {
  ...
  void _shareCode(String code, String link, BuildContext context) {
    ...
    Share.share(
      'Use my QuickFix referral code $code to get a welcome bonus of ₹50! Download app: $link',
    );
  }
            ...
            Padding(
              ...
              child: referralAsync.when(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          ErrorHandler.handle(err, st).message,
                ...
                data: (info) {
                  ...
                  final earned =
                      (info['referralRewardsEarned'] as num?)?.toDouble() ??
                      0.0;
                    ...
                    children: [
                      ...
                      ...[
                        const _HowItWorksStep(
                          ...
                          desc:
                              'Send your unique referral code to friends via WhatsApp, SMS or any platform.',
                        ),
                        const _HowItWorksStep(
                          number: '2',
                          title: 'Friend signs up',
                          desc:
                              'Your friend downloads QuickFix and registers with your referral code.',
                        ),
                        const _HowItWorksStep(
                          number: '3',
                          title: 'Both get rewarded',
                          desc:
                              'You earn a ₹100 discount coupon. Your friend gets ₹50 as a welcome bonus!',
                        ),
                      ].asMap().entries.map(
                        (e) => _buildStep(e.value, isDark)
