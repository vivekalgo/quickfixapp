...
class OffersScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final offersAsync = ref.watch(profileOffersProvider);
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        onRefresh: () async => await ref.refresh(profileOffersProvider.future),
          ...
          error: (err, st) => SingleChildScrollView(
            ...
            child: Container(
              ...
              child: CommonErrorWidget(
                ...
                onRetry: () => ref.invalidate(profileOffersProvider),
              ),
            ),
          ),
          data: (offers) {
...
class _TicketClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.arcToPoint(
      const Offset(100, 0) + Offset(0, size.height),
