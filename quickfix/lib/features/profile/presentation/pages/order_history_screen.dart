...
class _OrderHistoryScreenState extends ConsumerState<OrderHistoryScreen>
    ...
    return Scaffold(
      ...
      body: bookingsAsync.when(
        ...
        error: (err, st) => RefreshIndicator(
          ...
          onRefresh: () async =>
              await ref.refresh(customerBookingsProvider.future),
      ...
      child: list.isEmpty
                  ...
                  children: [
                    ...
                    Text(
                      tabType == 'active'
                          ...
                          : 'Your $tabType orders will appear here',
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildOrderCard(order, isDark, tabType)
                ...
                children: [
                  ...
                  if (tabType == 'active') ...[
                    if (order.status == 'pending' || order.status == 'accepted')
                      OutlinedButton(
                        onPressed: () =>
                            _showCancelDialog(context, order.id, isDark),
                    ...
                    ElevatedButton.icon(
                      onPressed: () =>
                          _showRatingBottomSheet(context, order, isDark),
                      icon: const Icon(
                        Icons.star_outline,
                        size: 14,
                        color: Colors.white,
              ...
              onPressed: isCancelling
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        await repository.cancelBooking(orderId);
                        ref.invalidate(customerBookingsProvider);
                        ...
                        if (dialogCtx.mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                'Failed to cancel. Is server running?',
                              ),
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
  ...
  void _triggerInvoiceDownload(BuildContext context, String orderId) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Downloading Invoice #$orderId...'),
        backgroundColor: AppColors.success,
        behavior: SnackBarBehavior.floating,
      ),
    );
