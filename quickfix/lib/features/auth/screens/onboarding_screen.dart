...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = const [
    OnboardingPage(
      ...
      description: 'Connect with verified electricians, plumbers, and cleaning experts nearSwamp Nagar in minutes.',
      icon: Icons.search,
      color: AppColors.catCleaningIcon,
    ),
    OnboardingPage(
      title: 'Schedule on Your Terms',
      description: 'Select your preferred date and time slot. Track provider arrival real-time on live map overlays.',
      icon: Icons.event_note,
      color: AppColors.catCarpentryIcon,
    ),
    OnboardingPage(
      title: '100% Assured Quality',
      description: 'QuickFix offers a 30-day rework warranty on all orders with secure payment protection.',
                    ...
                    child: Row(
                      children: [
                        Text(
                          ...
                          style: AppTextStyles.badgeText.copyWith(fontSize: 13, fontWeight: FontWeight.bold),
                        ),
