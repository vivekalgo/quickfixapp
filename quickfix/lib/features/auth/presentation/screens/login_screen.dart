    ...
    try {
      ...
      await FirebaseAuth.instance.verifyPhoneNumber(
        ...
        codeSent: (String verificationId, int? resendToken) {
          ...
          _startTimer();
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Verification OTP code sent to your phone number.')),
          );
        },
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to initialize verification: ${e.toString()}')),
        );
      }
    }
  }
              ...
              if (!_isOtpSent) ...[
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: 8.0),
                ...
                Row(
                  ...
                  children: [
                    Text(
                      _timerCount > 0 ? 'Resend code in ${_timerCount}s' : 'Didn\'t receive code?',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isLoading
                        ? const CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(Colors.white))
                        : const Text('Verify & Proceed', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                  ),
