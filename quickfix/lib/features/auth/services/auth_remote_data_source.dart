...
class AuthRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getProfile() async {
    ...
    return ApiResponseValidator.requireMap(response.data, context: 'getProfile');
  }
  ...
  Future<Map<String, dynamic>> updateProfile(Map<String, dynamic> updateData) async {
    ...
    return ApiResponseValidator.requireMap(response.data, context: 'updateProfile');
  }
  ...
  Future<String> uploadAvatar(String base64Image, String mimeType) async {
    ...
    final data = ApiResponseValidator.requireMap(response.data, context: 'uploadAvatar');
  ...
  Future<Map<String, dynamic>> getReferralInfo() async {
    ...
    return ApiResponseValidator.requireMap(response.data, context: 'getReferralInfo');
  }
