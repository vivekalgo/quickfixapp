...
import 'package:quickfix/features/booking/models/service_package.dart';
    ...
    final List<Map<String, String>> faqs = [
      {
        ...
        'a':
            'Our professionals carry premium, eco-friendly, and non-toxic cleaning agents along with heavy-duty vacuum machines and micro-fiber cloths. You do not need to provide anything.',
      },
      {
        'q': 'Do I need to be present during the service?',
        'a':
            'While not mandatory, we recommend being present at the start of the service to align on specific areas and at the end to inspect and verify satisfaction.',
      },
      {
        'q': 'Is there a warranty or re-work guarantee?',
        'a':
            'Yes, QuickFix provides a 100% satisfaction guarantee. If you are not satisfied with the quality, we will schedule a free re-work session within 30 days.',
      },
    ];
        ...
        slivers: [
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Hero(
                tag: pkg.id,
                child: Image.network(pkg.imageUrl, fit: BoxFit.cover),
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(pkg.title, style: AppTextStyles.headingLarge(isDark)),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 8),
                        _buildCheckRow(
                          'Eco-friendly, child & pet safe cleaning sprays',
                          Colors.green,
                        ),
                        const SizedBox(height: 8),
                        _buildCheckRow(
                          'Post-service cleanup and vacuuming',
                          Colors.green,
                        ),
                      ],
                    ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildCheckRow(
                          'Moving of heavy wooden beds/wardrobes',
                          Colors.red,
                          isClose: true,
                        ),
                        const SizedBox(height: 8),
                        _buildCheckRow(
                          'Hard water stain cleaning inside tiles (requires specialized chemical treatment)',
                          Colors.red,
                          isClose: true,
                        ),
                      ],
                      ...
                      : ElevatedButton(
                          onPressed: () {
                            ...
                            ref
                                ...
                                .addItem(pkg.id, pkg.title, pkg.price);
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: isDark
