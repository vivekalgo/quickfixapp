                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: isDark 
                            ...
                            : Border.all(color: AppColors.borderLight.withValues(alpha: 0.6)),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: [
                          Row(
                            children: [
                              CircleAvatar(
                                radius: 24,
                                backgroundImage: ResizeImage(NetworkImage(prof.avatarUrl.isNotEmpty ? prof.avatarUrl : 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150'), width: 150),
                              ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: prof.availability ? Colors.green.withValues(alpha: 0.1) : Colors.red.withValues(alpha: 0.1),
