              ...
              Expanded(
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 16,
                      backgroundImage: ResizeImage(NetworkImage(r.userAvatar.isNotEmpty ? r.userAvatar : 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150'), width: 100),
                    ),
