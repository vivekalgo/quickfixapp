...
import 'package:quickfix/core/logging/crash_reporter.dart';

/// Levels of logging priority.
enum LogLevel { verbose, debug, info, warning, error }

/// Unified enterprise logger managing runtime traces, API requests/responses, and navigation tracking.
/// 
...
class AppLogger {
  ...
  static void _log(
    ...
    if (kDebugMode) {
      ...
      final tagStr = tag != null ? '[$tag] ' : '';
      CrashReporter.logBreadcrumb('$tagStr$sanitizedMessage');
    }
  }
}
