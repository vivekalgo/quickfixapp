                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(
                                dashboardState.stats.isOnline
                                    ? 'ONLINE'
                                    : 'OFFLINE',
                                style: TextStyle(
                                  color: dashboardState.stats.isOnline
                                      ? AppColors.success
                                      : AppColors.danger,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 12,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      CurrencyFormatter.format(
                                        dashboardState.stats.walletBalance,
                                      ),
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                      ...
                      GridView.count(
                        ...
                        children: [
                          _buildStatCard(
                            'Today\'s Orders',
                            dashboardState.stats.todayOrders.toString(),
                            Icons.today,
                            Colors.blue,
                            isDark,
                          ),
                          _buildStatCard(
                            'Pending Requests',
                            dashboardState.stats.pendingOrders.toString(),
                          ...
                          _buildStatCard(
                            'Accepted Jobs',
                            dashboardState.stats.acceptedOrders.toString(),
                          ...
                          _buildStatCard(
                            'Completed Jobs',
                            dashboardState.stats.completedOrders.toString(),
