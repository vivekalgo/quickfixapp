              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildDetailRow(
                      'PAN Number',
                      shop.pan.isNotEmpty ? shop.pan : 'Not Verified',
                      Icons.credit_card_rounded,
                    ),
                    const Divider(height: 24, color: Colors.white10),
                    _buildDetailRow(
                      'GSTIN Code',
                      shop.gst.isNotEmpty ? shop.gst : 'Not Provided',
                    ...
                    _buildDetailRow(
                      'Owner Email',
                      shop.email.isNotEmpty ? shop.email : 'Not Provided',
                      Icons.email_rounded,
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _buildDetailRow(
                      'IFSC Code',
                      shop.ifscCode.isNotEmpty ? shop.ifscCode : 'Not Provided',
                      Icons.gavel_rounded,
                    ),
                    const Divider(height: 24, color: Colors.white10),
                    _buildDetailRow(
                      'UPI ID',
                      shop.upiId.isNotEmpty ? shop.upiId : 'Not Provided',
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () => _showInfoDialog(
                        'Compliance',
                        'All customer details revealed to partners must strictly remain confidential. Providers must not copy, distribute, or contact customers post-service closure.',
                      ),
                    ),
                  ],
                ),
