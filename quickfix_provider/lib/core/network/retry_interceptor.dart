...
class RetryInterceptor extends Interceptor {
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) async {
    ...
    // Only retry GET requests (safe requests) to avoid duplicate state mutations
    ...
    if (isSafeMethod && hasNotExceededMax && isRetryableError) {
      ...
      debugPrint(
        '[RetryInterceptor]: Retrying request ${requestOptions.method} ${requestOptions.uri} (Attempt $retryCount of $maxRetries) in ${delay.inMilliseconds}ms...',
      );
